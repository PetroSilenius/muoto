...
export default async function Page() {
  return (
    <div className="flex flex-col items-center">
      ...
      <Suspense fallback={
          <>
          <div role="status" className="max-w-sm rounded border border-gray-200 shadow animate-pulse dark:border-gray-700">
          <div className="flex justify-center items-center h-80 w-96 bg-gray-300 rounded dark:bg-gray-700">
